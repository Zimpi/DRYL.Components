...
/// <summary>
/// A bag of parameter values forwarded to the dialog component. Keys match the
/// component's <c>[Parameter]</c> property names.
/// </summary>
/// <example>
/// <code>
/// var p = new DialogParameters { ["UserId"] = id, ["ReadOnly"] = true };
/// await Dialogs.ShowAsync&lt;EditUserDialog&gt;("Edit", p);
/// </code>
/// </example>
